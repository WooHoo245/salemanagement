...
namespace FruitsHouse
{
    public partial class frmMatHang : Form
    {
        ...
        private void FrmMatHang_Load(object sender, EventArgs e)
        {
            ...
            HienChiTiet(false);
            // TODO: This line of code loads data into the 'freshfruitDataSet.SANPHAM' table. You can move, or remove it, as needed.
            this.sANPHAMTableAdapter.Fill(this.freshfruitDataSet.SANPHAM);
        ...
        {
            if (MessageBox.Show("Bạn có chắc chắn xóa mã mặt hàng" + txtMaSP.Text + "không? Nếu có ấn nút Có, không thì ấn nút Hủy", "Xóa sản phẩm", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
        ...
        private void BtnLuu_Click(object sender, EventArgs e)
        {
            ...
            sql = "INSERT INTO SANPHAM(MaSP,TenSP,NgayNH,NgayHH,DVTinh,DonGia,GhiChu)VALUES (";
